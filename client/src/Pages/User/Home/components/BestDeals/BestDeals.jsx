...
// return (
//   <div className="w-full lg:w-[80%] mx-auto pt-14 px-4">
//     <div className="flex justify-between items-center">
//       <div>
//         <h3 className="font-bold text-xl md:text-2xl">Best Deals</h3>
//         <h6 className="py-1 flex text-xs font-semibold">
//           <span className="text-gray">Showing 9 of 25 results</span>
//           <span className="text-primary px-2 cursor-pointer hover:underline">
//             View more
...
//           <div
//             key={index}
//             className="border-[1px] shadow-lg border-lightGray rounded-md flex flex-col cursor-pointer"
//           >
//             <img
