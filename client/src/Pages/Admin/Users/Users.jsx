  ...
  return (
    <div className="">
      <div className="flex justify-between items-center">
        <BodyHeader heading="Customers" subHeading="Manage your customers" />
        <HeaderActions
          pdfAction={() => {}}
          excelAction={() => {}}
          printAction={() => {}}
              ...
              {Array.from({ length: 5 }, (_, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="text-center">Customer {index + 1}</td>
                    <td className="text-center">
                      customer{index + 1}@example.com
                    </td>
                    <td className="text-center">City {index + 1}</td>
                    <td className="text-center">123-456-7890</td>
